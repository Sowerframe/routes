...
class RuleItem extends Rule
{
     ...
     */
    public function __construct(Route $router, RuleGroup $parent, string $name = null, string $rule = '', $routes = null, string $method = '*')
    {
        $this->router = $router;
        $this->parent = $parent;
        $this->name   = $name;
    ...
    public function checkRule(Request $request, string $url, $match = null, bool $completeMatch = false)
    {
        ...
        if (false !== $match) {
            return $this->parseRule($request, $this->rule, $this->routes, $url, $option, $match);
        }
